...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn("z-50 min-w-[8rem] rounded-2xl border border-border bg-popover p-2 text-popover-foreground shadow-xl", className)}
    {...props}
  />
))
...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn("z-50 min-w-[12rem] rounded-2xl border border-border bg-popover p-2 text-popover-foreground shadow-xl", className)}
      {...props}
    />
  </DropdownMenuPrimitive.Portal>
))
